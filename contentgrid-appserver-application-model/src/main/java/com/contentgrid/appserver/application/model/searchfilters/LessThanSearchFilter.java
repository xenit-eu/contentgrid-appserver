...
/**
 * A search filter that performs a less than operation on attribute values.
 * <p>
 * This filter can be used to find entities where an attribute is strictly less than a specified value.
 * It supports all numeric and date-time attribute types.
 */
@EqualsAndHashCode(callSuper = true)
@Value
public class LessThanSearchFilter extends OrderedSearchFilter {

    /**
     * Constructs a LessThanSearchFilter with the specified parameters.
     *
    ...
    public static class LessThanSearchFilterBuilder {
        public LessThanSearchFilterBuilder attribute(@NonNull SimpleAttribute attribute) {
