...
public class ModelTestFixtures {
    ...
    public static final Entity INVOICE = Entity.builder()
            ...
            .searchFilter(SimpleAttributeSearchFilter.builder()
                    ...
                    .attributePath(INVOICE_RECEIVED)
                    .build())
            .searchFilter(SimpleAttributeSearchFilter.builder()
                    .operation(Operation.LESS_THAN)
            ...
            .searchFilter(SimpleAttributeSearchFilter.builder()
                    ...
                    .attributePath(INVOICE_PAY_BEFORE)
                    .build())
            .searchFilter(SimpleAttributeSearchFilter.builder()
                    .operation(Operation.LESS_THAN)
            ...
            .searchFilter(SimpleAttributeSearchFilter.builder()
                    ...
                    .attributePath(INVOICE_CONFIDENTIALITY)
                    .build())
            .searchFilter(SimpleAttributeSearchFilter.builder()
                    .operation(Operation.EXACT)
