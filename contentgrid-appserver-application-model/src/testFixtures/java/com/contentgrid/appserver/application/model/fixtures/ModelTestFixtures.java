...
public class ModelTestFixtures {
    ...
    public static final Entity PERSON = Entity.builder()
            ...
            .searchFilter(AttributeSearchFilter.builder()
                    ...
                    .attributePath(PropertyPath.of(RelationName.of("invoices"), AttributeName.of("amount")))
                    .build())
            .searchFilter(AttributeSearchFilter.builder()
            ...
            .searchFilter(AttributeSearchFilter.builder()
                    ...
                    .attributePath(PropertyPath.of(RelationName.of("invoices"), AttributeName.of("received")))
                    .build())
            .searchFilter(AttributeSearchFilter.builder()
                    .operation(Operation.LESS_THAN)
            ...
            .searchFilter(AttributeSearchFilter.builder()
                    ...
                    .attributePath(PropertyPath.of(RelationName.of("invoices"), AttributeName.of("pay_before")))
                    .build())
            .searchFilter(AttributeSearchFilter.builder()
                    .operation(Operation.LESS_THAN)
            ...
            .searchFilter(AttributeSearchFilter.builder()
                    ...
                    .attributePath(PropertyPath.of(RelationName.of("invoices"), AttributeName.of("pay_timestamp")))
                    .build())
            .searchFilter(AttributeSearchFilter.builder()
                    .operation(Operation.LESS_THAN)
